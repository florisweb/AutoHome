...
void webSocketEvent(WStype_t type, uint8_t * payload, size_t length) {
  ...
  switch (type) {
    ...
    case WStype_TEXT:
      ...
      } else if (packetType == "auth" && doc["data"] == true)
      {
...
void connectionManager::setup(const char* _ssid, const char* _password, const String _deviceId, const String _deviceKey) {
  deviceId = _deviceId;

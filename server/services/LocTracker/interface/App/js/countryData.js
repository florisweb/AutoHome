const CountryData = new class {
  ...
  map2To3Name(_2Name) {
    let fullName = this.names2[_2Name];
    let compareArr = Object.keys(this.names3).map(r => [stringSimilarity(this.names3[r], fullName), r]);
    compareArr.sort((a, b) => a[0] > b[0]);
    return compareArr[0][1];
  }
  map3To2Name(_3Name) {
    let fullName = this.names3[_3Name];
    let compareArr = Object.keys(this.names2).map(r => [stringSimilarity(this.names2[r], fullName), r]);
    compareArr.sort((a, b) => a[0] > b[0]);
    return compareArr[0][1];
  }
}
